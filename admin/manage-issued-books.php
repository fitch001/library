                                                ...
                                                foreach ($results as $result) {               ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->iss_id); ?>"><button class="btn btn-primary"><i class="fa fa-check "></i>Check</button>
